...
/// Return true if \p MI is a valid target for DebugLine emission.
/// Types, constants, decorations hoisted to module sections are marked
/// skip-emission; structural function opcodes are excluded.
